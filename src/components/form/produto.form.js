     ...
     return(
         <div style={{marginTop:80,marginLeft:20}}>
             <Form id={id}  initialData={initialData} onSubmit={handleSubmit}>
                 ...
                 <InputCustom required label="Categoria"  name={'categoria'}  variant="outlined"  type={'text'}  />
                 <InputCustom required label="Código de Barras"  name={'codigoBarra'}  variant="outlined"  type={'text'}  />
